...
import { useDayEntriesQuery, useReopenDayMutation } from "@/lib/queries/useDayEntries";
...
export const CloseDayRecap: React.FC = () => {
  ...
  const reopenDayMutation = useReopenDayMutation();
  const reopenDay = (d: string) => reopenDayMutation.mutate(d);
