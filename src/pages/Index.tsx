  ...
  return (
    <section>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2 bg-surface-raised border border-dashed border-border-subtle rounded-[4px] px-3 py-2 max-md:fixed max-md:left-0 max-md:right-0 max-md:bottom-0 max-md:z-40 max-md:bg-surface-base max-md:border-x-0 max-md:border-b-0 max-md:border-dashed-0 max-md:border-t max-md:border-t-border-subtle max-md:rounded-none max-md:px-4 max-md:py-3">
          <input
            value={quickAdd}
